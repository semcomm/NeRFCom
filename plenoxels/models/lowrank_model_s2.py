...
from plenoxels.models.kplane_field_s2 import KPlaneField
...
class LowrankModel(nn.Module):
    ...
    # def get_params(self, lr, ntc_lr=1e-4, aux_lr=1e-3):
    def get_params(self, lr, ntc_lr=1e-4, aux_lr=1e-4):
        ...
        ntc_params = model_params["ntc"]
        aux_params = model_params["aux"]
        return [
            {"params": field_params, "lr": lr},
            {"params": nn_params, "lr": lr},
            {"params": other_params, "lr": lr},

            {"params": ntc_params, "lr": ntc_lr},
